---
name: knack-realtime
description: Use when wiring near-real-time updates from Knack to HTI's Vercel dashboards without aggressive polling — webhook-style change feeds, debounced refresh, event-driven dashboard updates, or SSE/WebSocket-shaped patterns over Knack's REST surface. Trigger on any "live update", "auto-refresh", or "polling is killing rate limit" task.
allowed-tools: Read
---
