...
description: Use when generating AI-powered insight layers, visual summaries, or stakeholder dashboards from HTI's Knack operational data. Transforms raw records into actionable intelligence for grant reporting, board presentations, and donor communications. Trigger on any HTI dashboard design, narrative summary, or "make this Knack data tell a story" request.
