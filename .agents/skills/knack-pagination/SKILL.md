...
description: Use when retrieving full datasets from Knack that exceed the 1,000-record-per-page limit — HTI's 3,500+ laptop inventory, full participant lists, multi-year compliance pulls. Handles paging cursors without dropping records. Trigger whenever "all records", "every laptop", or "complete export" is needed from Knack.
allowed-tools: Read
---
