---
name: knack-reader
description: Use whenever reading HTI Knack data via REST — Objects, Views, filtered queries, single records, or bulk extracts. The primary entry point for any HTI operational data read; pairs with knack-auth, knack-pagination, and knack-cache-optimizer. Trigger on any "pull the Knack data", "read the laptop records", or "show me what's in object X" request.
allowed-tools: Read
---
