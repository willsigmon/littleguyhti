...
description: Use when running HTI's Digital Champion Grant reports, NCDIT quarterly submissions, or internal stakeholder reports. Pulls from Knack, validates compliance fields, and outputs grant-ready packets. Trigger on any "quarterly report", "grant submission", "NCDIT packet", or recurring HTI compliance reporting task.
allowed-tools: Read
---
