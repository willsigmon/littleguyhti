...
description: Use when tracking HTI's progress against grant goals and BD goals — milestone status, at-risk targets, attainment forecasting, and early-warning alerts. Generates actionable insights for staff and board check-ins. Trigger on any "are we on track", grant-milestone, or BD-pipeline-status request.
allowed-tools: Edit
---
